          ...
          <div class="card-content">
            <div class="row">
              <div class="col l8 m8 s8">
                  <h5>Asep Saepul Rohman (CV Online)</h4>
      ...
      <div id="test1" class="col s12">
          ...
          <div class="row">
            ...
            <div class="col l5 m12 s12">
              ...
              <div class="input-field">
                <input type="date" class="datepicker" id="thnin" placeholder="Tahun Masuk">
                <!-- <label for="birth">Birth <span class="red-text">(*)</span></label> -->
              </div>
              <div class="input-field">
                <input type="date" class="datepicker" id="thnin" placeholder="Tahun Keluar">
                <!-- <label for="birth">Birth <span class="red-text">(*)</span></label> -->
              </div>
            </div>
            <!-- /kanan -->
